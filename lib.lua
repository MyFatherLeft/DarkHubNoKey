if game.CoreGui:FindFirstChild("Gaymer2019") then
    game.CoreGui.Gaymer2019:Destroy()
end
game:GetService("UserInputService").InputBegan:connect(
    function(key, gpe)
        if key.KeyCode == Enum.KeyCode.RightControl then
            game.CoreGui.Gaymer2019.Enabled = not game.CoreGui.Gaymer2019.Enabled
        end
    end
)
